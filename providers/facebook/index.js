...
function loginHelper(appState, email, password, globalOptions, callback) {
  ...
  mainPromise = mainPromise
    .then(function(res) {
      ...
      log.info('[Facebook] Request to pull 1');
      var form = {
    ...
    .then(function(resData) {
      ...
      log.info("[Facebook] Request to pull 2");
      return utils
        .get("https://0-edge-chat.facebook.com/pull", ctx.jar, form);
    })
    .then(function() {
      ...
      log.info("[Facebook] Request to thread_sync");
  ...
  mainPromise
    .then(function() {
      log.info('[Facebook] Done logging in.');
      return callback(null, api);
    })
    .catch(function(e) {
      log.error("[Facebook] Error in login:", e.error || e);
      callback(e);
    });
}
